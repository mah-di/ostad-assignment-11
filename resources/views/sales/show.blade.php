        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <a class="" href="{{ route('sale.create', ['product_id' => $product->id]) }}">
                        <span class="px-4 py-2 rounded-md bg-green-500/75 hover:bg-green-500 text-sm text-extrabold text-white">
                            MAKE SALE
                        </span>
                    </a>
                    &nbsp;
